...
async function main() {
  const proposalId = "0xedf736834eddfdf18de6d61cdf277460ef7330fa43816a24ef5df6445198b397";
  ...
  console.log("🔍 Verifying New Proposal\n");
  ...
  console.log("Description:", details[1].substring(0, 200) + "...");
  ...
  console.log("\n" + "=".repeat(70));
  console.log("✅ New proposal verified successfully!");
}
